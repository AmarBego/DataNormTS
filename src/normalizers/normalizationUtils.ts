...
/**
 * Checks if the given value is an array of EntityID.
 * 
 * @param value - The value to check.
 * @returns True if the value is an array of EntityID, otherwise false.
 */
...
/**
 * Checks if the given value is an EntityID.
 * 
 * @param value - The value to check.
 * @returns True if the value is an EntityID, otherwise false.
 */
